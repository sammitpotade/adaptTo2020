...
- [Lesson 4 - Test Changes on AEM as Cloud Service](#lesson-4---test-changes-on-aem-as-cloud-service)
  ...
  - [Lesson Context](#lesson-context-2)
    ...
    - [Exercise 4.4 - Review Custom Workflow Runner Config](#exercise-44---review-custom-workflow-runner-config)
    - [Exercise 4.5 - Upload assets](#exercise-45---upload-assets)
...
### Exercise 4.4 - Review Custom Workflow Runner Config
1. In AEM as Cloud Service, you can review OSGi configuration using Developer console.
   
2. To open developer console: https://dev-console-ns-team-aem-cm-prd-n13704.ethos13-prod-gbr9.dev.adobeaemcloud.com/#release-cm-p18053-e46178
3. Get Status Dump in JSON format for Configuration

 ![Developer Console](assets/L3/Developer-console.png)

4. Search for "CustomDamWorkflowRunnerImpl" to see the Custom DAM Workflow Runner configuration
    ![Custom Workflow Runner](assets/L3/CustomWorkflowRUnner.png)
5. This is configuration generated by the workflow migration tool to map existing launcher to trigger custom post processing workflow.

Now that we have reviewed all the changes on AEM Cloud Service, lets upload assets & make sure everything works.

### Exercise 4.5 - Upload assets
